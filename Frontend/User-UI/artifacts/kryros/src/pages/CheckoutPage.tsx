                    ...
                    <div className="absolute left-0 right-0 top-full mt-1 z-20 bg-background border border-border rounded-2xl shadow-xl overflow-hidden">
                      {mobileNetworks.map((net) => (
                        <button
                          ...
                          className={`w-full flex items-center px-4 py-3.5 text-left hover:bg-muted transition-colors border-b border-border last:border-0 ${mmProvider === net ? "bg-primary/5" : ""}`}
                        >
                          <span className={`text-sm font-semibold flex-1 ${mmProvider === net ? "text-primary" : "text-foreground"}`}>{net}</span>
                          {mmProvider === net && (
            ...
            {openMethod === "bank" && (
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  ).concat([{ label: "Reference", val: placedOrderNumber || "Your Order Number" }])
