      ...
      <div className="max-w-md mx-auto px-0 pb-24">
        ...
        {step === 1 && (
          <div className="flex flex-col min-h-[calc(100vh-80px)]">
            ...
            {/* Sticky bottom: Pay Now + Secure note */}
            <div style={{ position: "sticky", bottom: 0, background: "var(--background)", padding: "12px 16px 20px", borderTop: "1px solid var(--border)" }}>
              <button
              ...
              <div className="secure-note" style={{ marginTop: "8px", textAlign: "center", color: "var(--muted-foreground)", fontSize: "12px", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}>
