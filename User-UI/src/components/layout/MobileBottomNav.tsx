  ...
  return (
    ...
    >
      <div style={{ paddingBottom: "env(safe-area-inset-bottom)" }}>
        <div className="relative flex items-center justify-center mb-[-18px] z-10">
          <Link href="/pay">
            <button
              className={`w-20 h-20 rounded-full flex items-center justify-center transition-all ${
                location === "/pay" ? "bg-[var(--kryros-primary)] shadow-[0_6px_18px_rgba(39,185,175,0.35)]" : "bg-[var(--kryros-primary)] shadow-[0_6px_18px_rgba(39,185,175,0.25)]"
              }`}
            >
              <CreditCard
        ...
        <div className="mx-4 mb-4">
          <div className="bg-white rounded-[24px] shadow-2xl px-4 py-4 flex items-center justify-around">
                ...
                <Link key={href} href={href}>
                  <button className={`flex flex-col items-center gap-1 transition-all`}>
                    <div className="relative">
                      ...
                      />
                      {badge != null && badge > 0 && (
                        <span className="absolute -top-1 -right-1 bg-[var(--kryros-primary)] text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center">
                          {badge > 99 ? "99+" : badge}
                        </span>
                      )}
                    </div>
