...
function SupportFloatingButtons() {
  ...
  useEffect(() => {
    ...
    const positionZohoLauncher = () => {
      ...
      const bottomOffset = isDesktop ? 104 : 96;
  ...
  const buttonBaseClass =
    "w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-transform duration-200 hover:scale-110 active:scale-95";

  return (
    <div className="fixed right-4 bottom-20 md:bottom-24 z-50 flex flex-col items-end gap-2">
      <a
        href={whatsappUrl}
        target="_blank"
